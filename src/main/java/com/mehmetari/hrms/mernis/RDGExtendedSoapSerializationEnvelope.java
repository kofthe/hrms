...
public class RDGExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(RDGDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new RDGStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static RDGDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static RDGDateTimeConverter dateTimeConverter = new RDGStandardDateTimeConverter();

    public RDGExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public RDGExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new RDGMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=RDGHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,RDGExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=RDGHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
